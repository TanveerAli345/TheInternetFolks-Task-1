        ...
        <main className="hero">
            <div className="hero--desc">
                <h1 className="hero--heading">
                    Discover the <br/><span className="red-text">Best</span> Food<br/> and Drinks
                </h1>
            ...
            <div className="hero--graphics">
                <svg className="hero--svg" width="752" height="839" viewBox="0 0 752 839" fill="none" xmlns="http://www.w3.org/2000/svg">
